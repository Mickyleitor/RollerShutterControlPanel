        ...
        case SELECCION_MENU_SLEEP_MODE_ACTIVATE_CONFIRM: {
            switch (_localButton)
            {
                case BUTTON_STATUS_LEFT:
                    ...
                    break;
                case BUTTON_STATUS_RIGHT:
                    setScheduledDataFlag(sleepModeDaySelected, 
        ...
        case SELECCION_MENU_SLEEP_MODE_ACTIVATE_ALL_CONFIRM: {
            switch (_localButton)
            {
                case BUTTON_STATUS_LEFT:
                    ...
                    break;
                case BUTTON_STATUS_RIGHT:
                    setAllScheduledDataFlag((SCHEDULED_DATA_FLAG_DONE | SCHEDULED_DATA_FLAG_PENDING),
                                            SCHEDULED_DATA_FLAG_PENDING);
                    _nextMenu = SELECCION_MENU_SLEEP_MODE;
                    break;
            }
...
const struct MenuTransition menuTransitions[] = {
    {SELECCION_MENU_NONE, SELECCION_MENU_NONE, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, NULL, NULL},
    {SELECCION_MENU_INFO, SELECCION_MENU_PERSIANA_CENTRAL, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, actionSubirPersiana, actionBajarPersiana},
    {SELECCION_MENU_PERSIANA_IZQUIERDA, SELECCION_MENU_PERSIANA_DERECHA, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, actionSubirPersiana, actionBajarPersiana},
    {SELECCION_MENU_PERSIANA_CENTRAL, SELECCION_MENU_JOB_MODE, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, actionSubirPersiana, actionBajarPersiana},
    {SELECCION_MENU_PERSIANA_DERECHA, SELECCION_MENU_SLEEP_MODE, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, NULL, actionJobMode},
    {SELECCION_MENU_JOB_MODE, SELECCION_MENU_INFO, SELECCION_MENU_NONE, SELECCION_MENU_SLEEP_MODE_ACTIVATE, NULL, NULL, NULL, NULL},
    {SELECCION_MENU_SLEEP_MODE, SELECCION_MENU_SLEEP_MODE_DEACTIVATE, SELECCION_MENU_NONE, SELECCION_MENU_SLEEP_MODE_ACTIVATE_SEL_DATE_DAY, NULL, NULL, NULL, NULL},
    {SELECCION_MENU_SLEEP_MODE_ACTIVATE, SELECCION_MENU_SLEEP_MODE_ACTIVATE_SEL_DATE_MONTH, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, actionIncreaseDaySelected, actionDecreaseDaySelected},
    {SELECCION_MENU_SLEEP_MODE_ACTIVATE_SEL_DATE_DAY, SELECCION_MENU_SLEEP_MODE_ACTIVATE_CONFIRM, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, actionIncreaseMonthSelected, actionDecreaseMonthSelected},
    {SELECCION_MENU_SLEEP_MODE_ACTIVATE_SEL_DATE_MONTH, SELECCION_MENU_SLEEP_MODE, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, actionRegisterSleepMode, NULL, NULL},
    {SELECCION_MENU_SLEEP_MODE_ACTIVATE, SELECCION_MENU_SLEEP_MODE_ACTIVATE_ALL, SELECCION_MENU_NONE, SELECCION_MENU_SLEEP_MODE_DEACTIVATE_SEL_DATE_DAY, NULL, NULL, NULL, NULL},
    {SELECCION_MENU_SLEEP_MODE_DEACTIVATE, SELECCION_MENU_SLEEP_MODE_DEACTIVATE_SEL_DATE_DAY, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, actionIncreaseDaySelected, actionDecreaseDaySelected},
    {SELECCION_MENU_SLEEP_MODE_DEACTIVATE_SEL_DATE_DAY, SELECCION_MENU_SLEEP_MODE_DEACTIVATE_CONFIRM, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, actionIncreaseMonthSelected, actionDecreaseMonthSelected},
    {SELECCION_MENU_SLEEP_MODE_DEACTIVATE_SEL_DATE_MONTH, SELECCION_MENU_SLEEP_MODE, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, actionRegisterSleepMode, NULL, NULL},
    {SELECCION_MENU_SLEEP_MODE_DEACTIVATE, SELECCION_MENU_SLEEP_MODE_DEACTIVATE_ALL, SELECCION_MENU_NONE, SELECCION_MENU_SLEEP_MODE_ACTIVATE_ALL_CONFIRM, NULL, NULL, NULL, NULL},
    {SELECCION_MENU_SLEEP_MODE_ACTIVATE_ALL, SELECCION_MENU_SLEEP_MODE, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, actionRegisterSleepMode, NULL, NULL},
    {SELECCION_MENU_SLEEP_MODE_ACTIVATE_ALL, SELECCION_MENU_NONE, SELECCION_MENU_NONE, SELECCION_MENU_DEACTIVATE_ALL, NULL, NULL, NULL, NULL},
    {SELECCION_MENU_SLEEP_MODE_DEACTIVATE_ALL, SELECCION_MENU_SLEEP_MODE, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, actionRegisterSleepMode, NULL, NULL},
    {SELECCION_MENU_SLEEP_MODE, SELECCION_MENU_PERSIANA_IZQUIERDA, SELECCION_MENU_NONE, SELECCION_MENU_INFO_WIFI_STATUS, NULL, NULL, NULL, NULL},
    {SELECCION_MENU_INFO, SELECCION_MENU_INFO_WIFI_SSID, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, NULL, NULL},
    {SELECCION_MENU_INFO_WIFI_STATUS, SELECCION_MENU_INFO_WIFI_IP, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, NULL, NULL},
    {SELECCION_MENU_INFO_WIFI_SSID, SELECCION_MENU_NONE, SELECCION_MENU_NONE, SELECCION_MENU_NONE, NULL, NULL, NULL, NULL},
};
